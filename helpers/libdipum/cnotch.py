...
def cnotch(type_filter: Any, notch: Any, M: Any, N: Any, C: Any, D0: Any, n: Any = 1):
    """
...
def rejectFilter(type_filter: Any, MO: Any, NO: Any, D0: Any, K: Any, C: Any, n: Any):
    """rejectFilter."""
...
def placeNotches(H: Any, filt: Any, delu: Any, delv: Any):
    """placeNotches."""
    M, N = H.shape
    U = 2 * int(abs(delu))
    V = 2 * int(abs(delv))
...
def processOutput(notch: Any, H: Any, M: Any, N: Any, center: Any):
    """processOutput."""
    # H is odd dims.
    ...
    # Helper to flip part
    def make_symmetric_row(row: Any, c: Any):
        """make_symmetric_row."""
        # row is 1D array.
