...
def boundarydir(x: Any, y: Any = None, orderout: Any = None):
    """
    ...
    if y is None:
        if x.ndim == 2 and x.shape[1] == 2:
            ...
            raise ValueError(
                "Invalid input arguments. Provide x and y, or x as Nx2 array."
            )
    else:
        y = np.array(y)
    ...
    A = np.array([[x_prev, y_prev, 1], [x_curr, y_curr, 1], [x_next, y_next, 1]])
