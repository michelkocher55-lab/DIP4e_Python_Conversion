...
def pyramid4e(I, h=None):
    ...
    a_float = resize(filtered_I_uint8, out_shape_a, order=3, mode='reflect', preserve_range=True, anti_aliasing=False)
    ...
    upsampled_a_float = resize(a, I.shape, order=3, mode='reflect', preserve_range=True, anti_aliasing=False)
