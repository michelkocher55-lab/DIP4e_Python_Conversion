...
from helpers.libdip.imageRotate4e import imageRotate4e

def edgeModel4e(edge_type, m, n, i_low, i_high, width=None, angle=0.0):
    """
    ...
    # Create profile
    midpoint = int(np.floor(n / 2)) + 1 # 1-based index in MATLAB logic. Python index: midpoint-1
