...
class Chapter12Mixin:
    ...
    def figure1247(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1247.png")
    ...
    def figure1248(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1248.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Saved {out_path}")
            plt.show()
        finally:
    ...
    def figure1249(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1249.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Saved {out_path}")
            plt.show()
        finally:
    ...
    def figure1250(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1250.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Saved {out_path}")
            plt.show()
        finally:
    ...
    def figure1252(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1252.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
    ...
    def figure1253(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1253.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Detected regions: {R.Count}")
            print(f"Saved {out_path}")
            plt.show()
    ...
    def figure1254(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1254.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Detected regions: {R.Count}")
            print(f"Saved {out_path}")
            plt.show()
    ...
    def figure1255(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1255.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Detected regions: {R.Count}")
            print(f"Saved {out_path}")
            plt.show()
    ...
    def figure1257(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1257.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Saved {out_path}")
            plt.show()
        finally:
    ...
    def figure1258(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1258.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Saved {out_path}")
            plt.show()
        finally:
    ...
    def figure1260(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1260.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
    ...
    def figure1261(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1261.png")
    ...
    def figure1263(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            out_dir = os.path.join(str(_Path(__file__).resolve().parents[2]), "output")
    ...
    def figure1266(self, data_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            fig.tight_layout()
            out_path = os.path.join(os.path.join(str(_Path(__file__).resolve().parents[2]), "output"), "Figure1266.png")
            fig.savefig(out_path, dpi=150, bbox_inches="tight")
            print(f"Saved {out_path}")
