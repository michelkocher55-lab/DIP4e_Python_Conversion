...
def main(show: bool = True) -> None:
    """Run Figure424_425.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Figure424_425")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().figure424_425(data_dir=input_data_dir)
