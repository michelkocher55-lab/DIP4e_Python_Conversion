...
def main(show: bool = True) -> None:
    """Run Figure113_skimage.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Figure113_skimage")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().figure113_skimage(data_dir=input_data_dir)
