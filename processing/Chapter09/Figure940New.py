...
def main(show: bool = True) -> None:
    """Run Figure940New.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Figure940New")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().figure940new(data_dir=input_data_dir)
