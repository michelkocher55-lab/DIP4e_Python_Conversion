...
def main(show: bool = True) -> None:
    """Run Figure1337-39.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Figure1337-39")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().figure1337_39(data_dir=input_data_dir)
