...
def main(show: bool = True) -> None:
    """Run Figure1335UsingNNToolbox.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Figure1335UsingNNToolbox")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().figure1335usingnntoolbox(data_dir=input_data_dir)
