...
def main(show: bool = True) -> None:
    """Run Figure1324LMSE.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Figure1324LMSE")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().figure1324lmse(data_dir=input_data_dir)
