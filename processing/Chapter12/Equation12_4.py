...
def main(show: bool = True) -> None:
    """Run Equation12_4.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Equation12_4")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().equation12_4(data_dir=input_data_dir)
