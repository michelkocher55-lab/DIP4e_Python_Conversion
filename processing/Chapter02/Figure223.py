...
def main(show: bool = True) -> None:
    """Run Figure223.py with explicit input/output paths."""
    input_data_dir = "AllDataFiles"
    output_dir = str(PROJECT_ROOT / "output")
    output_figure_base = str(Path(output_dir) / "Figure223")
    os.makedirs(output_dir, exist_ok=True)

    result = Dip().figure223(data_dir=input_data_dir)
    ...
    for idx, fig in enumerate(figures, start=1):
        ...
        print(f"{output_figure_base}{suffix}.png")
