...
def wavefilter(wname, kind='d'):
    ...
    if name in ('haar', 'db1'):
        ...
        ld = np.array([
            -1.059740178499728e-002, 3.288301166698295e-002,
        ...
        ld = np.array([
            -7.576571478927333e-002, -2.963552764599851e-002,
        ...
        ld = np.array([
            0, 1.908831736481291e-003, -1.914286129088767e-003,
        ...
        hd = np.array([
            0, 0, 0, 1.442628250562444e-002, -1.446750489679015e-002,
        ...
        ld = np.array([
            0, 0.02674875741080976, -0.01686411844287495,
