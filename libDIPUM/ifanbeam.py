...
def ifanbeam(F, D, FanRotationIncrement=1.0, FanSensorSpacing=1.0, filter='ramp', OutputSize=None):
    """
    ...
    # 4. Inverse Radon
    # Map filters
    filter_map = {'Ram-Lak': 'ramp', 'Hamming': 'hamming', 'Hann': 'hann', 
                  'Cosine': 'cosine', 'Shepp-Logan': 'shepp-logan'}
    ...
    if OutputSize is not None:
        ...
        if g_recon.shape != target_shape:
            g_recon = resize(g_recon, target_shape, anti_aliasing=True, preserve_range=True)
