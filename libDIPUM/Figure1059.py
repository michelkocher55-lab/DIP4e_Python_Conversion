...
def Figure1059():
    ...
    S2 = nCutSegmentation(I_smooth, 2, edgeVariance=0.9, sample_rate=0.2, sampleRadius=20)
    ...
    S3 = nCutSegmentation(I_smooth, 3, edgeVariance=0.9, sample_rate=0.2, sampleRadius=20)
    S3_norm = mat2gray(S3)
