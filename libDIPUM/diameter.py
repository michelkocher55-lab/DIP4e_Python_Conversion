...
def compute_diameter_region(props, image_shape):
    """
    ...
    if num_pixels == 0:
        ...
        # Let's verify size.
        if num_pixels > 2000:
            print(f"Warning: computing diameter with {num_pixels} points. Might be slow.")
...
def compute_basic_rectangle(props, majoraxis, perim_r, perim_c):
    """
...
def diameter(label_image):
    ...
    for props in props_list:
        ...
        res.BasicRectangle, res.MinorAxis = compute_basic_rectangle(props, maj_ax, pr, pc)
        results.append(res)
