...
def x2majoraxis(A, B):
    ...
    if is_image:
        ...
        C = rotate(B, rotation_angle, resize=True, order=0, preserve_range=True).astype(B.dtype)
        ...
        C = rotate(B, rotation_angle, resize=False, order=0, preserve_range=True).astype(B.dtype)
        ...
        # Rotate
        img_rot = rotate(img_filled, rotation_angle, resize=False, order=0, preserve_range=True)
