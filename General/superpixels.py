...
def superpixels(A, N, method='slic', compactness=20, **kwargs):
    """
    ...
    try:
        ...
        raise ImportError("skimage is required for superpixels. Please install scikit-image.")
    ...
    try:
        ...
        segments = slic(image, n_segments=N, compactness=compactness, start_label=1, **kwargs)
    except TypeError:
