...
def edge(I, method='sobel', threshold=None, sigma=None):
    """
    ...
    # --- Helper: NMS ---
    def non_max_suppression(mag, orient):
        """
        ...
        nms[mask_45] = (mag[mask_45] >= m_45_TR[mask_45]) & (mag[mask_45] >= m_45_BL[mask_45])
        
        # 90
        mask_90 = (angle >= 67.5) & (angle < 112.5)
        nms[mask_90] = (mag[mask_90] >= m_90_T[mask_90]) & (mag[mask_90] >= m_90_B[mask_90])
        
        # 135
        mask_135 = (angle >= 112.5) & (angle < 157.5)
        nms[mask_135] = (mag[mask_135] >= m_135_TL[mask_135]) & (mag[mask_135] >= m_135_BR[mask_135])
