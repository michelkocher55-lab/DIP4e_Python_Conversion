...
def Figure1335():
    ...
    for i in range(4):
        ...
        if Target[0, i] > 0.5:
            plt.plot(Input[0, i], Input[1, i], 'or', markersize=10, markerfacecolor='none', markeredgewidth=2)
        else:
            plt.plot(Input[0, i], Input[1, i], 'og', markersize=10, markerfacecolor='none', markeredgewidth=2)
