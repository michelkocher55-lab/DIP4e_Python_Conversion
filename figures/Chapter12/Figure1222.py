...
for i in range(len(FileNames)):
    ...
    ax[i].set_title(f'{Compactness1[i]:.6g}, {Circularity1[i]:.6g}, {Eccentricity1[i]:.6g}')
    ax[i].axis('off')
fig1.tight_layout()
...
for i, name in enumerate(FileNames):
    ax3.stem([Circularity1[i]], [Eccentricity1[i]], [Compactness1[i]], linefmt='C0-', markerfmt='C0o', basefmt=' ')
